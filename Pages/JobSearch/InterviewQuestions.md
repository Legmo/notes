...
Задачки:
- console.log
- написать функцию - принимает строку и число Х. Вырезает из строки Х знаков '!', и возвращает строку-реузльтат. Решил через map. Можно было через filter, но так тоже ок.
