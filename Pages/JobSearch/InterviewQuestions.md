...
[//]: # (Оптимизация работы DOM браузера)
<details><summary><b>Оптимизация работы DOM браузера</b></summary><p>
...
- Обращаться к DOM как можно реже.
  - Если обратился — сохрани элемент в пременной, чтоб не искать повторно
