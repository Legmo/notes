...
- Перечитать свои резюме (hh.ru, linkedin, doc-файлы...), освежить
...
- Подготовить открытые вкладки — подглядывать на собеседовании (Legmo notes, свои резюме, вакансия, learnjs, mdm,
  reactjs.org)
