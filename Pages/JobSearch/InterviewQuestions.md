...
- Просмотреть заметки [Lebmo notes](https://github.com/Legmo/notes). Знать в каком файле что лежит
- Повторить темы из
  файла [Подборки вопросов-ответов для собеседования разработчик](https://github.com/Legmo/notes/blob/master/Pages/JobSearch/InterviewQuestions.md)
  . Обратить внимание на разделы:
  - Повторять
  - Из личного опыта
  - Популярные задачки
  - остальные можно пролистать
- Перечитать свои резюме (hh.ru, linkedin, doc-файлы...)
- Подготовить открытые вкладки, подглядывать во время собеседования - Legmo notes, свои резюме, вакансия, learnjs, mdm,
  reactjs.org
- Почитать переписку с рекуртёром, посмотреть свои заметки по рекуртёру
- Полистать свои публичные проекты на GitHub которые доступны рекуртёру — чтоб ответить на вопросы по своему коду
...
- Открыть редактор с JS кодом, набирать-проверять что вывел
