...
- 10 - Написать HOC  async throttle
  ...
  ```js
    ...
    run()
  ```
- 11 - Написать асинхронную функцию-светофор
    - Задача на понимание асинхронности.  
    - Должна в бесконечном цикле выводить в консоль сообщения с определенными интервалами
      - "Зеленый" 25 секунд
      - "Желтый" 5 секунд 
      - "Красный" 30 секунд  
- 12 - Вернуть массив одинаковых повторяющихся значений
    Дано 2 отсортированных по возрастанию массива чисел. Нужно вернуть массив одинаковых повторяющихся значений.  
