...
- Если провести за рубежом 183 (чуть менее 6 мес) дня или дольше в течение 12 месяцев, следующих подряд.
- Резидент вы или нет, важно только для НДФЛ.
...
[//]: # (Техническое собеседование — уточнить у рекуртёра)
<details><summary><b>Техническое собеседование — уточнить у рекуртёра</b></summary><p>
...
- Какой грейд подразумевается для этой вакансии? Junior, middle, senior...
- Моя роль на проекте
- Какие есть особенности у этой вакансии?
- Какого сотрудника ищете? Какими качествами должен обладать идеальный сотрудник?
  Для каких целей и задач компания ищет человека (задать прямой вопрос). 
...
[//]: # (Проект)
<details><summary><b>Проект</b></summary><p>

- О проекте. Чем занимается команда?
- Какие задачи и этапы?
...
- Стэк технологий (см ниже «Инструменты»)
<br></p>
</details>

[//]: # (Команда)
<details><summary><b>Команда</b></summary><p>

- Сколько человек на проекте (бэк/фронт/тест/прочие)
- Как давно команда работает в таком составе?
- Определены ли точные роли в команде?
- Давно ли они работают в команде, чем занимались?
- Есть ли у команды завершенные проекты? Или собрана под этот проект? Каковы показатели проектов (успешность)?
- Митинги - насколько часто, в какое время, на каком языке, с видео/без
- Есть ли общение на английском?
- Есть ли какие-то корпоративные правила?
<br></p>
</details>
...
- Организационная структура, иерархия руководства?
- Кто руководит? Какой у него стаж руководства, есть ли успешные завершенные проекты?
- Кому я непосредственно буду подчиняться?
- Какие границы у этого подчинения?
...
- Заинтересована ли компания в моем обучении?
- Оплачивает ли она курсы/сертификаты? Хекслет, HTML-academy...
- Ментор
- Код-ревью
- Есть ли система грейдов? Схема карьерного роста?
- Как часто и на каком основании пересмотр позиции?
...
- Льготные условия банковского обслуживания для сотрудников? (актуально прежде всего при работе в финт.тех компании)
- ИП необходимо?
- Самозанятость?
- льготная ипотека
- льготные условия банковского обслуживания для сотрудников?
...
- Испытательный срок есть?
- Условия прохождения?
- Отличия от полноценного трудоустройства?
