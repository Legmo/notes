...
[//]: # (Уточнить)
<details><summary><h3>Уточнить</h3></summary><p>
...
- It-компания с гос. аккредитацией Минцифры, сертификация как it-специалист
  - льготная ипотека
  ...
  - IT-компания должна быть аккредитована Минцифры.
    ...
    - Список аккредитованных IT-компаний есть на сайте Минцифры.
      ...
      Компания не менее одного отчетного периода должна пользоваться налоговыми льготами и/или пониженными страховыми
      тарифами.
-
...
- Плюшки
  ...
  - доп. дни к отпуску
  - оплата обучения, в том числе в той компании где я хочу
