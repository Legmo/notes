...
Хук в React — функция, с помощью которой можно использовать state и методы жизненного цикла в функц. компонентах.

Не работает в классовых компонентах. Хуки следует вызывать только из функциональных компонентов.
...
React содержит несколько встроенных хуков, таких как `useState`.<br>
Можно создавать собственные хуки, чтобы повторно использовать их в других компонентах.
