...
- `componentDidMount`
  ...
  - функция effect вызовется только при монтировании и размонтировании компонента
- `componentDidUpdate`
  - если передать не пустой массив зависимостей
  - функция effect вызовется когда изменится любое значение из массива зависимостей,  
- `componentWillUnmount`
