...
- <details><summary><b>Ключевые особенности</b></summary><p>
  ...
  - `Однонаправленная передача данных` — свойства передаются от родительских компонентов к дочерним (сверху-вниз). Компонент не может напрямую изменять свойства родителя, но может вызывать изменения через callback функции.
...
- <details><summary><b>Реактивность</b></summary><p>
  ...
  - 
  - Помните, что входными данными для `render()` являются свойства (`props`) и внутреннее состояние (`state`), которое может быть обновлено в любое время.
  - Когда для `render()` меняются входные данные, меняется и результат ее выполнения.ивел лишь с целью показать разницу в подходах.
...
- <details><summary><b>Фреймворки и библиотеки</b></summary><p>
  ...
  - [`Create React App`](https://create-react-app.dev/docs/getting-started) — для быстрого создания базового приложения
  - [`Next.js`](https://nextjs.org/) — поддержка Server-Side Rendering (SSR), TypeScript, роутинга...
  - [`Gatsby`](https://www.gatsbyjs.com/) — формирует статический HTML, который можно выложить на сервер
  - [`Blitz.js`](https://blitzjs.com/) — версия Ruby on Rails в духе React и JS.
  - [`Remix`](https://remix.run/docs/en/main) — заточен под SSR (server-side rendering). Opensource
  - 
  - 
  - **Библиотека**
...
<details ><summary><b>Рендер. Гидратация. Изоморфность.</b></summary><p>

[//]: # (Рендер, отрисовка)
- <details><summary><b>Рендер, отрисовка</b></summary><p>
...
[//]: # (3 основных подхода)
- <details><summary><b>3 основных подхода</b></summary><p>

  - `Рендеринг на клиенте` (Client Side Render, CSR) 
    - браузер скачивает почти пустой HTML, потом выкачивает большой JS (возможно разбыиты на «бандлы»), только потом страница отображается.
  ...
  - `Рендеринг на сервере` (Server Side Render, SSR)
    - весь HTML готовится на сервере. Браузер скачивает этот HTML и показывает пользователю. Потом докачивает скрипты.
  ...
  - `Прогрессивный рендеринг` на стороне сервера (Progressive Server Side Render)
    - мин. необходимый HTML готовится на сервере. Браузер скачивает этот HTML и показывает пользователю. Потом подгружаются скрипты и остальной HTML.
...
- <details><summary><b>Гидратация. Регидратация</b></summary><p>
...
- <details><summary><b>React hydrate() / hydrateRoot()</b></summary><p>
...
- <details><summary><b>Параллельный рендер в React (Concurrent rendering)</b></summary><p>
  ...
  - <details><summary><b>Повторно используемое состояние</b> (reusable state)</summary><p>
  ...
  - <details><summary><b>StrictMode и поиск ошибок</b></summary><p>
...
- <details><summary><b>Рендер на стороне сервера</b></summary><p>
...
- <details><summary><b>Styled components</b></summary><p>
  ...
  - **Ссылки**
    ...
    - [Medium - How to use styled components with Material UI in a React app (2019)](https://medium.com/sipios/use-styled-components-with-material-ui-react-e0759f9a15ce)
...
<details><summary><b>Графики, визуализация данных — популярные библиотеки</b></summary><p>

[//]: # (D3.js)
- <details><summary><b>D3.js</b></summary><p>
...
[//]: # (Victory)
- <details><summary><b>Victory</b></summary><p>
...
[//]: # (Nivo)
- <details><summary><b>Nivo</b></summary><p>
...
[//]: # (Chart.js)
- <details><summary><b>Chart.js</b></summary><p>
...
[//]: # (Google Charts)
- <details><summary><b>Google Charts</b></summary><p>
...
[//]: # (Rechart)
- <details><summary><b>Rechart</b></summary><p>
...
[//]: # (Vis)
- <details><summary><b>Vis</b></summary><p>
...
[//]: # (VX)
- <details><summary><b>VX</b></summary><p>
...
[//]: # (WebDataRocks)
- <details><summary><b>WebDataRocks</b></summary><p>
...
[//]: # (Flexmonster)
- <details><summary><b>Flexmonster</b></summary><p>
...
[//]: # (JSCharting)
- <details><summary><b>JSCharting</b></summary><p>
...
[//]: # (Highcharts)
- <details><summary><b>Highcharts</b></summary><p>
...
[//]: # (AmCharts)
- <details><summary><b>AmCharts</b></summary><p>
...
[//]: # (ZingChart)
- <details><summary><b>ZingChart</b></summary><p>
...
[//]: # (FusionCharts)
- <details><summary><b>FusionCharts</b></summary><p>
...
[//]: # (KoolChart)
- <details><summary><b>KoolChart</b></summary><p>
...
[//]: # (Как оптимизировать рендер компонента)
- <details><summary><b>Как оптимизировать рендер компонента</b></summary><p>

  - `shouldComponentUpdate` — метод жизненного цикла классового компонента, если он вернет false то рендер не будет запущен
  - `React.PureComponent` — класс, реализующий типовой shouldComponentUpdate.
  - `React.memo` — HOC, который предотвращает повторный рендер, если входные props не изменились
  - `useMemo()` — чтобы в функциональном компоненте сохранить ссылки на объекты между рендерами
  - `useCallback()` — чтобы в функциональном компоненте сохранить ссылки на объекты между рендерами - аттрибуты key
...
[//]: # (Какие хуки использовать для оптимизации рендера)
- <details><summary><b>Какие хуки использовать для оптимизации рендера</b></summary><p>
...
- <details><summary><b>Изменение параметров функции, side-эффекты и cloneDeep</b></summary><p>
...
- <details><summary><b>Side-эффекты в методах жизненного цикла</b></summary><p>
...
- <details><summary><b>Ссылки</b></summary><p>
  ...
  - [Medium - 7 методов оптимизации производительности React (2023)](https://medium.com/nuances-of-programming/7-%D0%BC%D0%B5%D1%82%D0%BE%D0%B4%D0%BE%D0%B2-%D0%BE%D0%BF%D1%82%D0%B8%D0%BC%D0%B8%D0%B7%D0%B0%D1%86%D0%B8%D0%B8-%D0%BF%D1%80%D0%BE%D0%B8%D0%B7%D0%B2%D0%BE%D0%B4%D0%B8%D1%82%D0%B5%D0%BB%D1%8C%D0%BD%D0%BE%D1%81%D1%82%D0%B8-react-133f235545e7)
...
[//]: # (Модуль)
- <details><summary><b>Модуль</b></summary><p>
...
<details><summary><b>React JS и React Native</b></summary><p>
...
[//]: # (Связывание данных)
- <details><summary><b>Связывание данных</b></summary><p>
...
- <details><summary>Устанавливая пакет - дописывать в конце `--save`</summary><p>
  ...
  - Пример: `npm install react-router-dom --save`
...
- <details><summary><b>Избегать изменения элементов/данных по ссылке</b></summary><p>
  ...
  - Если объект одноуровневый - можно сделать его полноценную копию так (через спред-оператор): `newObject = {...oldObject}`
