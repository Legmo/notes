...
[//]: # (Способы различения дестктопа / мобильного)
<details><summary><b>Способы различения дестктопа / мобильного</b></summary><p>

Два основных варианта:

- по ширине экрана. Определяем ширину скриптом (напрмиер `window.innerWidth`), храним в `state`, сравниваем с
  константами-breakpoints
- по user-agent
