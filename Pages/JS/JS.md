...
`Среда` (JS Run-time Enviroment) — надстройка над движком. <br>
Отвечает за создание экосистемы с возможностями, сервисами и поддержкой.<br>
Поддерживает работу с Document Object Model, Browser Object Model, CSSOM (спецификация для CSS), ключевые библиотеки и
т.п.
...
Web API... Потому что все движки основываются на одном стандарте - ECMAScript
