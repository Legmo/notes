...
- «Скрытые» свойства объектов.<br>
  - создать Symbol, а затем использовать сохранённое значение для создания свойства объекта.
  - ```js
...
- Есть много системных символов, используемых внутри JS, доступных как `Symbol.*.` 
...
**Глобальные символы**
- Если хотим, чтобы одноимённые символы были равны — использовать глобальный реестр: 
