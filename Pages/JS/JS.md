...
JavaScript создавался как скриптовый язык для Netscape. 1997 год<br>
Изначально разработкой занимались Брендан Эйх, Марк Андрессен и Билл Джой.<br>
После был отправлен в ассоциацию «ECMA International» для стандартизации. Стандартизированная версия имеет название
