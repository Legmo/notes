...
Движок JS бесконечно перемалывает операции, которые последовательно берутся из стека вызовов (1). <br>
...
`Окружение` — надстройка над движком (иногда называют `web API`).
