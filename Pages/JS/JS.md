...
- <details><summary><b>Изменение области видимости во время выполнения</b></summary><p>
  - Если использовать `НЕ strict` режим, есть 2 случая, когда область видимости может измениться уже после компиляции (т.е. во время выполнения программы)
  - Их не надо использовать! Это делает код запутанным + очень снижает быстродействие!
  - Вот они
