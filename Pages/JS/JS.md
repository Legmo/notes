...
- Все функции, блоки кода и скрипты имеют скрытый объект `LexicalEnvironmen`. На верхнем уровне это «глобальный
...
- В процессе выполнения функция будет оперировать данными \ информацией. То есть функция - это одно, а данные, с
