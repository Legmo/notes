...
[//]: # (Определение из книги Симпсона)
<details><summary><b>Определение из книги Симпсона</b></summary><p>

  - Замыкания — ссылка из внутренней функции на переменную во внешней области видимости.
  - Замыкание — когда функция использует переменную из другой области видимости даже при выполнении в области видимости, в которой эта переменная должна быть недоступна.
