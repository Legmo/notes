...
Такой механизм — «прототипное наследование». Это возможность языка.<br>
...
`[[Prototype]]` — свойство объекта. Внутреннее и скрытое.<br>
`__proto__` — свойство объекта (устаревшее). Геттер/сеттер для `[[Prototype]]`. Указывает на следующий прототип в цепочке (`null` если это последний прототип).
...
**Методы работы с прототипами** (вместо `__proto__`)
...
- Прототипы никак не влияют на `this`.
  ...
  - [](https://learn.javascript.ru/prototype-inheritance#znachenie-this)
