...
- <details><summary><b>Порядок выполнения промисов и их обработчиков</b></summary><p>
  ...
  - Часто встречается в задачах типа: в каком порядке выведутся console.log
  ...
  - Если хочешь передать данные в следующий обработчик - в .then() должен быть `return`. Явный или не явный
