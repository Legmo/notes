...
- <details><summary><b>Кратко</b></summary><p>
    ...
    - в движке работает n компиляторов и интерпретаторов. Могут применяться последовательно или специализироваться для разных типов кода (часто используемый и т.д.)
...
[//]: # (Окружение / Среда)
- <details><summary><b>Окружение (Среда)</b></summary><p>
...
[//]: # (Движок JS)
- <details><summary><b>Движок JS (JS Engine)</b></summary><p>
