...
[//]: # (Пример 2 - через стрелочные функции)
<details><summary><b>Пример 2 - через стрелочные функции</b></summary><p>
...
[//]: # (Пример 3)
<details><summary><b>Пример 3 - через анонимную самовыполняющуюся функцию (IIFE)</b></summary><p>
