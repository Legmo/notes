...
[//]: # (Интерфейс)
<details><summary>Интерфейс</summary><p>

То как мы взаимодействуем с чем-то
...
Конструкционный шаблон (архитектурный паттерн), описывает способ построения структуры приложения, сферы ответственности
и взаимодействие каждой из частей в этой структуре.

Основная идея: нужно чётко разделять ответственность за различное функционирование в наших приложениях. Делим приложение
на три основных компонента, каждый из которых отвечает за различные задачи.
