...
[//]: # (Инструкция)
- <details><summary><b>Инструкция</b> — отдельная команда или конструкция, которая выполняет действие. Ничего не вычисляет и не возвращает результат. «Строка программы». Отделяются «;»</summary><p>
