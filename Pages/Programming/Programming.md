...
[//]: # (Синтаксис)
- <details><summary><b>Синтаксис</b> — набор правил написания кода на этом языке. Какая комбинация символов является правильной (допустимой, осмысленной) конструкцией в этом языке.</summary><p>
