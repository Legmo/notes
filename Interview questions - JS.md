...
## JS - история версий ##
  ...
  * [Обзор новшеств ECMAScript 2016, 2017, и 2018 с примерами](https://habr.com/ru/company/ruvds/blog/353174/)
  ...
  - **Array.prototype.{flat,flatMap}** - позволяет рекурсивно сгладить массивы до заданной глубины и вернуть новый массив.
  ...
  - **Примитив BigInt** - для целых чисел (2^ <sup>53</sup>  - 1).
