...
1) Это личные заметки, а не техническая документация. Тут *могут содержаться ошибки*. Проверяйте информацию, прежде чем использовать in real-life. Для этого я привожу ссылки на источники "по теме".
1) База предназначена *для личного использования*. Поможет кому-то ещё - хорошо.
