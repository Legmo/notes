...
<details>
  ...
  * [9 сбивающих с толку соглашений об именовании](http://www.codeharmony.ru/materials/69) 
  ...
  <details>
      <summary><b>_ПЕРЕМЕННАЯ</b> - если название переменной написано ЗАГЛАВНЫМИ, её не надо менять. Это константа.</summary><p> 
  ...
  * [9 сбивающих с толку соглашений об именовании](http://www.codeharmony.ru/materials/69) 
  ...
  <details>
      <summary><b>_Переменная</b> - если название переменной начинается с заглавной, значит это не переменная а класс ООП.</summary><p> 
...
<details>
  ...
  <details>
    <summary>История версий ES</summary><p>
  ...
  * [Разъяснения насчёт JavaScript, ECMA–262, TC39 и транскомпиляторов ECMAScript](https://www.frontender.info/javascript-ecma-262-tc39-and-ecmascript-transpilers-explained/)
  ...
  <details>
    <summary>ES9 (ECMAScript 2018 )</b></summary><p>
  ...
  * [Что нового в ES2018 JavaScript](https://webformyself.com/chto-novogo-v-es2018-javascript/)
  ...
  <details>
    <summary>ES8 (ECMAScript 2017)</summary><p>
  ...
  * [Обзор новшеств ECMAScript 2016, 2017, и 2018 с примерами](https://habr.com/ru/company/ruvds/blog/353174/)  
  ...
  <details>
    <summary>ES7 (ECMAScript 2016)</summary><p>
  ...
  * [Обзор новшеств ECMAScript 2016, 2017, и 2018 с примерами](https://habr.com/ru/company/ruvds/blog/353174/)
  ...
  <details>
    <summary>ES6 (ECMAScript 2015)</summary><p>
...
<details>
  ...
  **Также:**
  ...
  - **Типизация** - динамическая слабая неявная (как и весь JS). Для введения статической типизации можно использовать propTypes / Flow / TypeScript (в порядке усложнения)
  ...
  - **Изоморфность** - код, который может выполняться и на клиентской, и на серверной стороне.При первом обращении к сайту все операции выполняются на сервере и в браузер передается HTML со всей информацией, как на обычных веб-сайтах со статическими страницами, которые поисковики могут проиндексировать. После загрузки JS сайт превращается в «одностраничное приложение», и работает соответственно.
  - **Быстрый** - в частности, потому что выполняет оптимизацию при компиляции кода в JSX -> JavaScrip
  - **Легко интегрировать** - может встраиваться в больше приложение по частям: часть уже работает на React, часть без него. И всё ок. Можно подключать через CDN и т.д.
  ...
  **Ссылки**
  ...
  <details>
    <summary><b>Что такое элементы</b></summary><p>
  ...
  Надо только учесть, ято когда мы работаем с JSX - мы не видим `React.createElement`. JSX позволяет писать это проще, но по факту, переделывает в тот самый `React.createElement`
  ```
  ...
  **Ссылки:**
  ...
  Компонент, же - класс или функция, которая принимает данные и возвращает элементы React.
  ...
  **Ссылки:**
  ...
  <details>
    <summary><b>Контейнерная и презентационная компонента (умная/глупая)</b></summary><p>

  Два типа компонент по типу задач, которые выполняют.
  
  **Контейнерная**
  
  Отвечают за данные и операции с ними. Например, берёт на себя общение со Store или AJAX запросы.<br> 
  Позволяет поддерживать внутреннюю (глупую) компоненту чистой.
  
  Всегда работают как обёртка вокруг другой контейнерной компоненты, или глупой компоненты. <br>
  ...
  Ответственны за работу внутренних механизмов приложения и взаимодействуют с состоянием Redux.
  ...
  **Презентационная**
  ...
  Отвечает лишь за отрисовку а экране полученных данных. И передачу в систему данных от пользователя (клик мышкой, ввод текста...)<br>
  ...
  **Ссылки:**
  ...
  <details>
    <summary><b>Компоненты с состоянием и без</b></summary><p>
    
   Некоторые компоненты используют в React метод setState(), а некоторые нет.<br>
   Этим, похоже и различаются
  ...
  **Функциональные** (stateless functional components) - простоые компоненты, созданные как функции.<br>
  React - функционально-ориентированная библиотека, так что рекомендуется использовать эти компоненты, там где можно. Кстати, они появились позже 
   ...
   Классовые - объявлены как класс, имеют методы жизненного цикла, локальное состояние, refs и многие другие штуки. <br>
  ...
  <details>
    <summary>Virtual DOM — это дерево React элементов на JavaScript.</summary><p>
...
- https://blog.csssr.ru/2016/12/07/react-perfomance      
  ...
  <details>
    <summary>Свойства (props) - произвольные данные, которые принимают компоненты. Это могут быть и функции.</summary><p>
  ...
  <details>
    <summaryKey - уникальное свойство (prop), связывает данные и элементы React.</summary><p>
  ...
  <details>
    <summary>Refs - «достучаться» к конкретному элементу и вызвать метод. Надо добавить атрибут ref в компонент для обратного вызова.</summary><p>
