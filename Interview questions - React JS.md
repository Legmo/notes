...
<details><summary><b>REACT - компоненты. Жизненный цикл</b></summary><p>
  ...
  **1. Монтирование** - вызываются, когда экземпляр компонента создаётся и вставляется в DOM (4)
  ...
  <details><summary><a href="https://ru.react.js.org/docs/react-component.html#static-getderivedstatefromprops">static getDerivedStateFromProps()</a></summary></details>
  ...
  <details><summary><b>componentWillMount()</b> - УСТАРЕВШИЙ! непосредственно перед рендерингом компонента</summary><p>
  ...
  **Эти методы считаются устаревшими, и вам следует избегать их в новом коде:**
  <details><summary>UNSAFE_componentWillReceiveProps()</summary><p>
  ...
  <br></p></details>
  <details><summary>UNSAFE_componentWillUpdate() - перед обновлением компонента (если shouldComponentUpdate вернул true)</summary></details>
