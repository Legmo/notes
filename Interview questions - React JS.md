...
<details>
  ...
  <details>
    <summary>key - уникальное свойство (prop), связывает данные и элементы React.</summary><p>
  ...
  * https://medium.com/frontend-notes/purecomponent-%D0%B8-components-5c15cf206ba7
  ...
  <details>
    <summary>React использует декларативный подход к программированию.</summary><p>
...
- структурное - декомпозиция
- модульное - разделение функционала на законченные блоки
...
...
Ссылки:
- [code.mu](http://code.mu/books/javascript/oop/)
- [code.mu](http://code.mu/books/php/oop/osnovy-raboty-s-objektno-orientirovannym-programmirovaniem-v-php-1.html)
- [javarush.ru](https://javarush.ru/groups/posts/1966-principih-obhhektno-orientirovannogo-programmirovanija)
- [habr](https://habr.com/ru/company/enterra/blog/153365/)
