...
<details><summary><b>REACT - КОМПОНЕНТЫ</b></summary><p>
  ...
  <details><summary>Компонент(а)</summary><p>
  
  (см выше)
     = функция. Возвращает какую-то JSX разметку.
  ...
  <details><summary>Названия компонент начинаются с Заглавной буквы.</summary><p>
  ...
  <details><summary>Компоненты = чистые функции</summary><p>
  ...
  - Все компоненты React должны действовать как чистые функции, сохраняя свои свойства. 
    ...
    <details><summary>Компоненты и Props</summary><p>
  ...
  **Неконтролируемые** - работают напрямую с виртуальным DOM деревом, обычно через ссылку ref. 
  ...
  <details><summary>Советы по организации кода</summary><p>
