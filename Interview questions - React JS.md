...
<details>
  ...
  Прописать область видимости. Отличия от var
</details>
...
<details>
  <summary>В JSX есть соглашение - все кастомные (т.е. мной созданные) компоненты называются с большой буквы (Aricle, MyComponent...).</summary>  
		Т.к. компонент = класс. 
