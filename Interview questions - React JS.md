...
<details>
  ...
  * v3 - Замыкание - способность функции запоминать контекст(e.g. LexicalEnvironment), в которой она была создана.
    
  Например, запоминила "a" из области своего создания, а потом, будучи вызванной уже вне этой области вернула это значение.<br> 
  ...
  * * *
  ...
  Насколько я знаю, то в функциональном программировании такой подход не приветствуется.
  ...
  * [learn.javascript.ru - Объекты](https://learn.javascript.ru/object)
  ...
  <details>
    <summary><b>var</b> используем в обычных случаях</summary>
    <ul>
  ...
  <details>
    <summary><b>let</b> используем если будем переопределять значение переменной. Видна в блоке</summary>
    <ul>
      <li>[learn.javascript.ru](https://learn.javascript.ru/variables)</li>
      <li>[learn.javascript.ru](https://learn.javascript.ru/let-const)</li>
    </ul>
  ...
  <details>
    <summary><b>const</b> используем для констант</summary>
    <ul>
      <li>[learn.javascript.ru](https://learn.javascript.ru/variables)</li>
      <li>[learn.javascript.ru](https://learn.javascript.ru/let-const)</li>
    </ul>
    <div>
      ...
      <p>Вообще хороший вариант объявления чего-то, что мы не собираемся менять</p>
  ...
  <details>
    <summary><b>_переменная</b> - если название переменной начинается с нижнего подчеркивания, ее не надо менять или читать снаружи объекта напрямую.</summary> 
  ...
  *[MDN](https://developer.mozilla.org/ru/docs/Web/JavaScript/Reference/Global_Objects/Math/ceil)
  ...
  <details>
    <summary><b>Promises</b> - способ организации асинхронного кода. Объект, который содержит своё состояние. </summary>
  ...
  <details>
    <summary><b>Proxy-объекты</b> - особые объекты, которые позволяют перехватывать и изменять действия, выполняемые над другими объектами.</summary>
