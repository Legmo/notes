...
- [csssr - Основы производительности React-приложений](https://blog.csssr.ru/2016/12/07/react-perfomance)
  ...
  <details>
    <summary><b>Что такое свойства (props)?</b></summary><p>
  ...
  ```      
    //Тут передаются props imageURL (значение - адрес), caption (текст), isMusicPlaying (функция)
    <PlayButton imageURL='http:tinyurl.comlkevsb9' caption='New York!' isMusicPlaying={this.state.isMusicPlaying} /> (см. imageURL & caption).
  ...
  <details>
    <summary>Композиция в React</summary><p>
