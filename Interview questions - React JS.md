...
<details>
  ...
  **Варианты определения** 
  ...
  Это не фрэймворк! React сам по себе не позволит создать веб-приложение, поскольку он предназначен для создания представлений (следовательно, это «V» в MVC). React может создать компонентные представления, данные которых могут передаваться дочерним представлениям. 
  ...
  **//ToDo - уточнить "какая часть системы отвечает за преобразование JS в HTML?" Скорее всего - браузер**
  ...
  **Также:**
  ...
  - **Рендеринг на стороне клиента** - используется  по умолчанию, можно настроить рендеринг на стороне сервера
  ...
  **Рендеринг на стороне сервера**
  ...
  <details>
    <summary>Элементы - то, из чего «сделаны» компоненты.</summary><p>
  ...
  <details>
    <summary>Контейнерная компонента - берёт на себя общение со Store (ООП-объект, хранящий state). И позволяет поддерживать внутреннюю компоненту чистой</summary><p>
