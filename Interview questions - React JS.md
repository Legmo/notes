...
<details>
  ...
  **Create React App**<br>
  ...
  <details>
    <summary><b>Что такое элемент?</b></summary><p>
  ...
  **Ссылки:**
  ...
  <details>
    <summary><b>Что такое компонент?</b></summary><p>
  ...
  **Ссылки:**
  ...
  <details>
   ...
   Stateful - компоненты имеющие состояние (state) всегда являются классовыми компонентами (у функциональных нет своего state). 
   Stateless - компоненты без состояния могут быть и функциональными и классовыми. Если можно обойтись функциональной - лучше её и использовать.
  ...
  **Функциональные** (stateless functional components) - простые компоненты, созданные как функции.<br>
  ...
  <details>
    <summary>Что такое Virtual DOM, зачем он нужен и как работает? //<b>ToDo - дополнить</b></summary><p>
  ...
  React следит за изменениями в Virtual DOM и автоматически изменяет DOM в браузере так, чтоб он соответствовал виртуальному.
   ...
   Проблема в том, что операции с Virtual DOM тоже могут быть медленными. Результат рендера Реакта — это многоуровневый объект. Сравнение результатов рендера — это не сравнение двух объектов по ссылке, а их полное, глубокое сравнение. Казалось бы, стоит держать компоненты небольшими, и тогда их перерендер будет происходить быстро.
   
   **Ссылки**
- [reactjs](https://ru.reactjs.org/docs/faq-internals.html)
- [medium](https://medium.com/@abraztsov/how-virtual-dom-work-567128ed77e9)
- [csssr](https://blog.csssr.ru/2016/12/07/react-perfomance)
